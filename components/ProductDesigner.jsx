...
function ProductDesigner() {
  return (
    <div className="mx-auto w-9/12 space-y-8">
      ...
      <div className="grid grid-cols-2 gap-10 text-4xl text-center text-white">
        <div className="bg-black py-10">🎨 Graphics designer</div>
        <div className="bg-[#330036] py-10">🎨 Ui/Ux designer</div>
      </div>
    </div>
  );
}
